    ...
    <main className="w-full bg-gray-50 text-gray-800">
      ...
      <section className="container mx-auto py-16 px-6 space-y-10">
        <div className="bg-white rounded-xl shadow-md p-8 space-y-6">
          ...
          <p>
            Welcome to <strong>Shree Wraps</strong>. By accessing our website
          ...
          <p>
            Our services are intended for personal and business use related to
            gift wrapping and luxury packaging. You agree not to misuse our
            services, attempt unauthorized access, or engage in fraudulent
            activities.
          </p>
          ...
          <p>
            ...
            subject to change without notice. Payments must be made in full at
            the time of purchase.
          </p>

          <h2 className="text-2xl font-semibold">4. Returns & Refunds</h2>
          <p>
            Returns are only accepted for damaged or defective products within 7
            days of delivery. Refunds will be processed according to our refund
            policy.
          </p>

          <h2 className="text-2xl font-semibold">5. Limitation of Liability</h2>
          <p>
            Shree Wraps is not liable for indirect, incidental, or consequential
