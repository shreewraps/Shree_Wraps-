...
const SUBCATS = [
  { key: "all", label: "All Charity Hampers" },
  { key: "kids", label: "Charity Hampers for Kids" },
  { key: "teens", label: "Charity Hampers for Teens" },
  { key: "adults", label: "Charity Hampers for Adults" },
  { key: "elderly", label: "Charity Hampers for Elderly" },
  { key: "special-kids", label: "Special Kids Charity Hampers" },
  { key: "widows", label: "Charity Hampers for Widows" },
  { key: "all-age-inclusive", label: "All-Age Inclusive Charity Hampers" },
];

export default function CharityGifts() {
